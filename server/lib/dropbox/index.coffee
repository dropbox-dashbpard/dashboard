...
router.get '/device', bearerAuth, dropbox.listDevices
router.get '/device/:id', bearerAuth, dropbox.getDevice
...
router.post '/ticket/:ticket/status/:status', bearerAuth, ef.updateTicket
